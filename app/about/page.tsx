...
export default function About() {
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-[#4a3428] via-[#6b4423] to-[#4a3428] py-28 overflow-hidden">
                {/* Background Pattern */}
                <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-20 left-20 w-96 h-96 bg-[#E67E3C] rounded-full blur-3xl"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-12">
                        <div className="inline-block mb-6">
                            <span className="bg-[#E67E3C]/20 text-[#E67E3C] px-5 py-2 rounded-full text-sm font-semibold border border-[#E67E3C]/30">
                                🌟 About Apothecary
                            </span>
                        </div>
                        <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                            Transforming Mental Healthcare,
                            <span className="text-[#E67E3C]"> One Life at a Time</span>
                        </h1>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                            <p className="text-4xl lg:text-5xl font-bold text-[#E67E3C] mb-2">10K+</p>
                            <p className="text-gray-300 text-sm font-medium">Lives Transformed</p>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                            <p className="text-4xl lg:text-5xl font-bold text-[#E67E3C] mb-2">500+</p>
                            <p className="text-gray-300 text-sm font-medium">Expert Assistants</p>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                            <p className="text-4xl lg:text-5xl font-bold text-[#E67E3C] mb-2">50K+</p>
                            <p className="text-gray-300 text-sm font-medium">Sessions Completed</p>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                            <p className="text-4xl lg:text-5xl font-bold text-[#E67E3C] mb-2">4.9/5</p>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <span className="text-[#E67E3C] font-semibold text-sm uppercase tracking-wide">Our Story</span>
                            <h2 className="text-4xl lg:text-5xl font-bold text-[#4a3428] mb-6 mt-3">
                            ...
                            <div className="mt-8">
                                <Link
                                    href="/contact"
                                    className="inline-flex items-center bg-gradient-to-r from-[#E67E3C] to-[#d16b2a] text-white px-8 py-4 rounded-full text-lg font-medium hover:shadow-xl transition-all duration-300 group"
                                >
                                    Get in Touch
                        ...
                        <div className="relative">
                            <div className="bg-gradient-to-br from-[#fef3e8] to-[#f5e6d3] rounded-3xl p-12 shadow-2xl hover:shadow-3xl transition-shadow duration-300">
                                <div className="space-y-8">
                                    <div className="flex items-start space-x-4 group">
                                        <div className="w-14 h-14 bg-gradient-to-br from-[#E67E3C] to-[#d16b2a] rounded-2xl flex items-center justify-center text-white flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300">
                            ...
                            {/* Decorative Element */}
                            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#E67E3C]/20 rounded-full blur-2xl -z-10"></div>
                            <div className="absolute -top-6 -left-6 w-32 h-32 bg-[#E67E3C]/20 rounded-full blur-2xl -z-10"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-gradient-to-br from-[#fef3e8] via-white to-[#f5e6d3]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <span className="text-[#E67E3C] font-semibold text-sm uppercase tracking-wide">Our Purpose</span>
                        <h2 className="text-4xl lg:text-5xl font-bold text-[#4a3428] mb-4 mt-3">
                            Mission & Vision
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
                            <div className="w-16 h-16 bg-gradient-to-br from-[#E67E3C] to-[#d16b2a] rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg">
                                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold text-[#4a3428] mb-4">Our Mission</h3>
                        ...
                        <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
                            ...
                            <h3 className="text-2xl font-bold text-[#4a3428] mb-4">Our Vision</h3>
                            <p className="text-gray-700 text-lg leading-relaxed">
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <span className="text-[#E67E3C] font-semibold text-sm uppercase tracking-wide">Our Values</span>
                        <h2 className="text-4xl lg:text-5xl font-bold text-[#4a3428] mb-4 mt-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={index} className="bg-gradient-to-br from-[#fef3e8] to-white rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group border border-gray-100">
                                ...
                                <h3 className="text-xl font-bold text-[#4a3428] mb-3">
                                    {value.title}
                                </h3>
                                <p className="text-gray-600 leading-relaxed">
                                    {value.description}
            ...
            <section className="py-24 bg-gradient-to-br from-[#fef3e8] via-white to-[#f5e6d3]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <span className="text-[#E67E3C] font-semibold text-sm uppercase tracking-wide">Our Team</span>
                        <h2 className="text-4xl lg:text-5xl font-bold text-[#4a3428] mb-4 mt-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                        {[
                            ...
                            <div key={index} className="bg-white rounded-3xl p-8 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group border border-gray-100">
                                <div className="w-32 h-32 bg-gradient-to-br from-[#E67E3C] to-[#d16b2a] rounded-full mx-auto mb-6 flex items-center justify-center text-white text-3xl font-bold shadow-xl group-hover:scale-105 transition-transform duration-300">
                                    {member.name.split(' ').map(n => n[0]).join('')}
                                </div>
                                <h3 className="text-2xl font-bold text-[#4a3428] mb-2">
                                    {member.name}
                                </h3>
                                <p className="text-[#E67E3C] font-semibold mb-3 text-lg">
                                    {member.role}
                                </p>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <span className="text-[#E67E3C] font-semibold text-sm uppercase tracking-wide">Trust & Recognition</span>
                        <h2 className="text-4xl lg:text-5xl font-bold text-[#4a3428] mb-4 mt-3">
                            Accreditations & Partnerships
                        </h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={index} className="bg-gradient-to-br from-[#fef3e8] to-white rounded-2xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-gray-100">
                                <div className="text-5xl mb-4">{cert.icon}</div>
                                <p className="font-semibold text-[#4a3428] text-lg">{cert.name}</p>
                            </div>
                        ))}
                    </div>
                </div>
