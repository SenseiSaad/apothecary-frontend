            ...
            <div className="relative">
              <div className="bg-white rounded-3xl shadow-2xl p-8 hover:shadow-3xl transition-shadow duration-300">
                ...
                <div className="flex space-x-2">
                  <button className="w-14 h-14 bg-gradient-to-br from-green-100 to-green-200 hover:from-green-200 hover:to-green-300 rounded-full flex items-center justify-center text-2xl transition-all duration-300 hover:scale-110 shadow-md">😊</button>
                  <button className="w-14 h-14 bg-gradient-to-br from-yellow-100 to-yellow-200 hover:from-yellow-200 hover:to-yellow-300 rounded-full flex items-center justify-center text-2xl transition-all duration-300 hover:scale-110 shadow-md">😐</button>
                  <button className="w-14 h-14 bg-gradient-to-br from-orange-100 to-orange-200 hover:from-orange-200 hover:to-orange-300 rounded-full flex items-center justify-center text-2xl transition-all duration-300 hover:scale-110 shadow-md">😔</button>
                  <button className="w-14 h-14 bg-gradient-to-br from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 rounded-full flex items-center justify-center text-2xl transition-all duration-300 hover:scale-110 shadow-md">❓</button>
                </div>
              </div>
